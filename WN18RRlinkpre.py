...
def train_model(model, criterion, optimizer, train_loader, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_loader:
            ...
            try:
                ...
                print("IndexError occurred during forward pass. Details:", e)
                print("Head:", head)
    ...
    torch.save(model.state_dict(), os.path.join(SAVED_MODELS_DIR, "trained_model_WN18RR.pth"))
...
if __name__ == "__main__":
    ...
    num_entities = max(train_data['head'].max(), train_data['tail'].max()) + 1
    num_relations = train_data['relation'].max() + 1
    embedding_dim = 100
